...
$('.stars').click(function(){
	...
	tt = Number(tt)+1;
	$(this).attr('times',tt);
	var t1 = $('#star1').attr('times');
	var t2 = $('#star2').attr('times');
	var t3 = $('#star3').attr('times');
	var t4 = $('#star4').attr('times');
	var t5 = $('#star5').attr('times');
...
$(document).ready(function(){
  // slider video play
    ...
    //QR img
    var qcode = {
      api : "https://www.mrxn.net/mrxnqrapi/api.php?site=weixin&data=",
